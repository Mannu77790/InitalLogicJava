...
import com.mm.model.*;
import java.util.*;
public class SortObjectComparator {
	public static void main(String[] args) {
		...
		fruits2.setQuantity(19);
		fruits.add(fruits2);
		
		fruits2 = new Fruits();
		fruits2.setName("Water Melon");
		fruits2.setDescription("Good Medium");
		fruits2.setQuantity(12);
		fruits.add(fruits2);
		...
		Collections.sort(fruits, Fruits.FruitNameComparator);
